...
import {Text, Box, Flex,  HStack, IconButton, Button, Menu, MenuButton, useDisclosure, useColorModeValue, Image,Stack, Input, FormControl, InputGroup,  InputRightElement, Avatar,  SimpleGrid, MenuList, MenuItem, Popover, PopoverTrigger, PopoverContent, PopoverArrow, PopoverCloseButton, Portal, PopoverHeader, PopoverBody, PopoverFooter} from '@chakra-ui/react';
...
// import caratlane from "/caratlane-logo.png"
            ...
            <Box  w={"100%"}  position="fixed" zIndex={"10"}    >
                <Flex boxShadow='lg' p='2'h={16} alignItems={'center'} gap={"10px"}  bg={useColorModeValue('#F6F4ff', '#F6F4ff')}>
                    ...
                    <HStack gap={"10px"} alignItems={'center'}  >
                        <Box>
                        <Image w={{base:"80px",md:"150px"}} src={"/caratlane-logo.png"} alt="log" />
                        </Box>
                        ...
                        <IconButton fontSize={{base:"5px",sm:"none",md:'20px'}} bg={"#F6F4ff"} icon={<IoStorefrontOutline/>} color="#4f3267" _hover={{ color: "#231535" }} />
                          ...
                          <Text fontFamily={"sans-serif"} fontSize={{ base: "8px",sm:"none", md: "11px" }} marginTop={"7px"}   color="#4f3267" _hover={{  color: "#000000", textDecoration: "underline" }}>PLAN OF PURCHASE</Text>
                           ...
                           <Popover>
                            <PopoverTrigger>
                            <IconButton fontSize={{base:"5px",sm:"13px",md:'15px'}} bg={"#F6F4ff"}  icon={<FaUser/>}  _hover={{ color: "#231535" }}/>
                            </PopoverTrigger>
                            <Portal>
                                <PopoverContent>
                                <PopoverArrow />
                                <PopoverHeader fontFamily={"sans-serif"} fontSize={"17px"} textAlign="center" >Your Account</PopoverHeader>
                                <PopoverCloseButton />
                                <PopoverBody fontFamily={"sans-serif"} fontSize={"13px"} textAlign="center">Access acount & manage your orders</PopoverBody>
                                <PopoverBody border='0'
                                    display='flex'
                                    alignItems='center'
                                    justifyContent='space-around'
                                    pb={4} >
                                   <Link to="/signIn" > <Button bg='#DE57E5'>Signup</Button></Link>
                                    <Link to="/login" ><Button borderColor='#DE57E5' variant='outline'>Login</Button></Link>
                                </PopoverBody>
                                </PopoverContent>
                            </Portal>
                            </Popover>
                            ...
                            <Link to={"/cart"} ><IconButton fontSize={{base:"5px",sm:"13px",md:'15px'}} bg={"#F6F4ff"} icon={<RiShoppingBasket2Line/>}  _hover={{ color: "#231535" }}/></Link>
                        </HStack>
                    </HStack> 
                </Flex>
