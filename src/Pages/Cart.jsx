...
import { getCartData, handleCouponDiscount, handleTotalAmount } from '../Redux/AppReducer/Cart/action'
      ...
      <Box border="1px solid white" w="100%">
            ...
            >
              ...
              <UnorderedList padding="0.5rem"  w="60%" display="flex" listStyleType="none" justifyContent="center">
                ...
                <ListItem mr="0rem" fontSize="1.2rem" fontWeight="500" justifyContent="space-evenly">
                Shopping Cart
                </ListItem>
                <ListItem>
                <Flex><Image src='https://www.iconpacks.net/icons/2/free-shopping-cart-icon-2029-thumb.png' maxW="2rem"></Image><span><Text as="b">{items}</Text></span>
                </Flex>
                </ListItem>
              </UnorderedList>
              </HStack>
                      ...
                      <Flex w="70%" h="auto">
                          <Flex w="100%" borderRight="1px solid" borderRightColor="rgb(233, 233, 233)">
                            <VStack w="95%">
                                ...
                                <Flex w="100%">
                                    <Text w="75%" fontFamily="MuliSemiBold,Helvetica, Arial, sans-serif" fontSize="1.1rem">Total Items ({items}) : ₹{amount}</Text>
