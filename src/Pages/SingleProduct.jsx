...
const SingleProduct = () => {
    ...
    const handleAddToCart = () => {
        ...
        const property = {
          ...
          imagelogo2:'https://www.kindpng.com/picc/m/340-3400180_home-logo-pink-png-transparent-png.png',
        }
    ...
    <div>
        ...
        >
            <Box  >
                <Flex>
                <Box >
                    <Text as="b" fontSize="20px">{product.name}</Text>
                </Box>
            ...
            <Flex>
                <Box h="100"  w="272px">
                    ...
                    <Text mt="2rem" fontSize="2xl">₹{product.price}  </Text>
               ...
               <SimpleGrid columns={2} spacing={7}>
                <Box h="150"  bg="#e5f4e0" >
                    <Box >
                        <Flex>
                            <Box  h="70px" w="90px"   >
                                <Image maxW="3rem" margin="auto" src={property.imagelogo1}></Image>
                            </Box>
                            <Box  h="70px" w="200px" >
                    ...
                    <Box h="70px" w="100%" >
                    <Button  margin="auto"   fontSize= "1.2rem" w="100%" size="lg" bg=" #75d167" color= "#ffffff" border= "none" >Schedule a Video Call</Button>
                    </Box>
                ...
                <Box >
                        <Flex>
                            <Box  h="70px" w="90px" >
                            <Image maxW="3rem" margin="auto" src={property.imagelogo2}></Image>
                            </Box>
                            <Box  h="70px" w="200px" >
                    ...
                    <Box h="70px"  w="100%">
                    <Button  margin="auto"   fontSize= "1.2rem" w="100%" size="lg" bg=" #de57e5" color= "#ffffff" border= "none" >Book Home Appoinment</Button>
                    </Box>
                </Box>
