import { Box, FormControl, Input, Button , FormLabel, Grid, GridItem, Image, Spacer, StackDivider, VStack, Flex, Text, HStack,Modal,
  ModalOverlay,
  ModalContent,
  ModalHeader,
  ModalFooter,
      ...
      <Box w="100%">
          ...
          <GridItem w='100%'  border="1px solid" borderColor="rgb(233,233,233)" padding="1.2rem">
              <form padding="4rem" onSubmit={handleSubmit}>
                  ...
                  <Button border="1px solid" borderColor="rgb(150, 150, 150)" bg="lightgreen" w="50%" margin="auto" type="submit" onClick={onOpen}>Place Order</Button>
                  </Flex>
